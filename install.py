...
install_paths = [
    # ('orm.calc.job.tbextraction', 'orm/calculation/job/tbextraction'),
    # ('parsers.plugins.tbextraction', 'parsers/plugins/tbextraction'),
    ('workflows.tbextraction', 'workflows/tbextraction'),
    # ('orm.data.tbextraction', 'orm/data/tbextraction'),
    # ('tools.codespc.tbextraction', 'tools/codespecific/tbextraction'),
    # ('djsite.db.subtests.tbextraction', 'djsite/db/subtests/tbextraction'),
    # ('commands', 'cmdline/tbextraction'),
    # ('../doc/source', '../docs/source/plugins/tbextraction')
]
