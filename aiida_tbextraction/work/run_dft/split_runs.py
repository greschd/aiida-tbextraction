...
class SplitDFTRuns(RunDFTBase):
    ...
    def define(cls, spec):
        ...
        spec.expose_inputs(ReferenceBandsBase, namespace='reference_bands', include=[])
        spec.expose_inputs(ToWannier90Base, namespace='to_wannier90', include=[])

        spec.outline(
            cls.run_dft, cls.finalize
        )
